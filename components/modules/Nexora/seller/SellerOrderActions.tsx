        ...
        <div className="flex flex-wrap gap-2">
          {transitions.map((s) => (
            <button
              ...
              className={
                s === "CANCELLED"
                  ? "rounded-full border border-red-300 bg-red-50 px-4 py-2 text-xs font-semibold text-red-700 transition-colors hover:bg-red-100 disabled:opacity-50"
        ...
        <div className="space-y-3 rounded-2xl border border-border bg-background p-4">
          ...
          {requiresReason && (
            <textarea
              ...
              rows={3}
              className="w-full rounded-xl border border-border bg-background px-3 py-2 text-sm outline-none focus:border-[#4E8D9C]"
            />
          )}
